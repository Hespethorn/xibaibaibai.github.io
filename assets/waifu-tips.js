...
live2d_settings['homePageUrl']          = 'https://xibaibaibai.github.io/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
...
function initModel(waifuPath, type) {
    ...
    live2d_settings.homePageUrl == 'https://xibaibaibai.github.io/' ? window.location.protocol+'//'+window.location.hostname+'/' : live2d_settings.homePageUrl;
